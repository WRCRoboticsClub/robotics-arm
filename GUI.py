...
shoulderLabel.pack()
shoulderleft=Button(shoulderFrame,text="Left",height=2,width=5)
shoulderleft.pack(side=LEFT)
shoulderright=Button(shoulderFrame,text="Right",height=2,width=5)
...
elbowLabel.pack()
elbowleft= Button(elbowFrame,text="Left",height=2,width=5)
elbowleft.pack(side=LEFT)
elbowright= Button(elbowFrame,text="Right",height=2,width=5)
...
wristLabel.pack()
wristleft= Button(wristFrame,text="Left",height=2,width=5)
wristleft.pack(side=LEFT)
wristright= Button(wristFrame,text="Right",height=2,width=5)
